...
@app.route('/sandeep',methods=['POST','GET'])
def index():
    if request.method == 'POST':
        ...
        try:
            ...
            #table = db[jsearchString]  # creating a collection with the same name as search string. Tables and Collections are analogous.
